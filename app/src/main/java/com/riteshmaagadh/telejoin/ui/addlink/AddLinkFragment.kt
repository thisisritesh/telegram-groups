package com.riteshmaagadh.telejoin.ui.addlink
...
import com.riteshmaagadh.telejoin.data.models.Index
import com.riteshmaagadh.telejoin.databinding.FragmentAddLinkBinding
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        lifecycleScope.launch(Dispatchers.IO) {
            FirebaseFirestore.getInstance()
                .collection("telegram_indexes")
                .document("8GVyW4OErzrLJ64Dm4rm")
                .get()
        ...
        binding.privacyPolicyTv.setOnClickListener {
            val url = "https://activetelegramgroups.blogspot.com/2022/11/telegram-groups-links-privacy-policy.html"
